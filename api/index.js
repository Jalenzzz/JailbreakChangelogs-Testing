...
app.use("https://jbc-2.b-cdn.net/assets", (req, res, next) => {
...
app.use((req, res, next) => {
  if (req.path.startsWith("https://jbc-2.b-cdn.net/assets/")) {
    res.setHeader("Cache-Control", "public, max-age=31536000, immutable");
    const oneYearFromNow = new Date();
    oneYearFromNow.setFullYear(oneYearFromNow.getFullYear() + 1);
    res.setHeader("Expires", oneYearFromNow.toUTCString());
  ...
  try {
    ...
    if (!latestResponse.ok || !requestedResponse.ok) {
      ...
      return res.status(status).render("error", {
        title,
        message,
        logoUrl: "https://jailbreakchangelogs.xyzhttps://jbc-2.b-cdn.net/assets/logos/Logo_Background.webp",
    ...
    const responseData = {
      ...
      logoUrl:
        "https://jailbreakchangelogs.xyzhttps://jbc-2.b-cdn.net/assets/logos/Logo_Background.webp",
...
app.get("/seasons/:season", async (req, res) => {
  ...
  try {
    ...
    const imageUrls = seasonData.rewards ? seasonData.rewards.map(reward => {
      ...
      if (reward.link && reward.link.startsWith('https://jbc-2.b-cdn.net/assets')) {
    ...
    if (imageUrls.length === 0) {
      imageUrls.push('https://jailbreakchangelogs.xyzhttps://jbc-2.b-cdn.net/assets/logos/Logo_Background.webp');
    }
...
app.get("/trading", async (req, res) => {
  try {
    ...
    res.render("trading", {
      ...
      logoUrl: "https://jailbreakchangelogs.xyzhttps://jbc-2.b-cdn.net/assets/logos/Logo_Background_Collab.webp",
...
app.get("/trading/ad/:tradeId", (req, res) => {
  ...
  res.render("trade-ad", {
    ...
    logoUrl:
      "https://jailbreakchangelogs.xyzhttps://jbc-2.b-cdn.net/assets/logos/Logo_Background_Collab.webp",
    logoAlt: "Trading Page Logo",
    MIN_TITLE_LENGTH,
    MIN_DESCRIPTION_LENGTH,
    tradeId,
...
app.get("/bot", (req, res) => {
  ...
  const image = `https://jbc-2.b-cdn.net/assets/backgrounds/background${randomNumber}.webp`;
  res.render("bot", {
...
app.get("/item/:type/:item", async (req, res) => {
  ...
  try {
    ...
    let embedImageUrl;
    if (item.type === "Drift") {
      embedImageUrl = `https://jailbreakchangelogs.xyzhttps://jbc-2.b-cdn.net/assets/images/items/drifts/thumbnails/${item.name}.webp`;
    } else if (item.type === "HyperChrome" && item.name === "HyperShift Lvl5") {
      embedImageUrl = `https://jailbreakchangelogs.xyzhttps://jbc-2.b-cdn.net/assets/images/items/hyperchromes/HyperShift Lvl5.gif`;
    } else if (item.type === "Horn") {
      embedImageUrl = `https://jailbreakchangelogs.xyzhttps://jbc-2.b-cdn.net/assets/audios/horn_thumbnail.webp`;
    } else {
      const pluralType = `${item.type.toLowerCase()}s`;
      embedImageUrl = `https://jailbreakchangelogs.xyzhttps://jbc-2.b-cdn.net/assets/images/items/${pluralType}/${item.name}.webp`;
    }
    ...
    let image_url;
    if (item.type === "Drift") {
      image_url = `https://jailbreakchangelogs.xyzhttps://jbc-2.b-cdn.net/assets/images/items/drifts/thumbnails/${item.name}.webp`;
    } else if (item.type === "HyperChrome" && item.name === "HyperShift Lvl5") {
      image_url = `https://jailbreakchangelogs.xyzhttps://jbc-2.b-cdn.net/assets/images/items/hyperchromes/HyperShift Lvl5.webm`;
    } else {
      const pluralType = `${item.type.toLowerCase()}s`;
      image_url = `https://jailbreakchangelogs.xyzhttps://jbc-2.b-cdn.net/assets/images/items/${pluralType}/${item.name}.webp`;
    }
...
const getAvatar = async (userId, avatarHash, username) => {
  const defaultAvatarUrl = "https://jbc-2.b-cdn.net/assets/default-avatar.png";
