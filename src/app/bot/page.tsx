          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="bg-secondary-bg border-border-primary hover:border-border-focus hover:shadow-card-shadow rounded-lg border p-6 transition-colors duration-200 hover:shadow-lg">
              ...
              <p className="text-card-paragraph">
                Check player inventories directly from Discord with /inventory commands. View
                detailed item listings without leaving your server.
              </p>
            </div>
            ...
            <div className="bg-secondary-bg border-border-primary hover:border-border-focus hover:shadow-card-shadow rounded-lg border p-6 transition-colors duration-200 hover:shadow-lg">
              ...
              <p className="text-card-paragraph">
                Find original owners of rare items using /og commands in Discord. Track item
                provenance and authenticity directly through the bot.
              </p>
            </div>
            ...
            <div className="bg-secondary-bg border-border-primary hover:border-border-focus hover:shadow-card-shadow rounded-lg border p-6 transition-colors duration-200 hover:shadow-lg">
              ...
              <p className="text-card-paragraph">
                Check for duplicated items with /dupe commands. Verify item authenticity before
                trading.
              </p>
            </div>
            ...
            <div className="bg-secondary-bg border-border-primary hover:border-border-focus hover:shadow-card-shadow rounded-lg border p-6 transition-colors duration-200 hover:shadow-lg">
              ...
              <p className="text-card-paragraph">
                View latest season content and rewards without leaving Discord. Stay updated on
                seasonal progress and requirements.
              </p>
            </div>
            ...
            <div className="bg-secondary-bg border-border-primary hover:border-border-focus hover:shadow-card-shadow rounded-lg border p-6 transition-colors duration-200 hover:shadow-lg">
              ...
              <p className="text-card-paragraph">
                View previous changelogs and seasons directly from Discord. Browse the complete
                history of Jailbreak updates.
              </p>
            </div>
            ...
            <div className="bg-secondary-bg border-border-primary hover:border-border-focus hover:shadow-card-shadow rounded-lg border p-6 transition-colors duration-200 hover:shadow-lg">
              ...
              <p className="text-card-paragraph">
                Receive DMs when users want to trade with you and get trade ads automatically posted
                to our Discord server for maximum visibility.
              </p>
            </div>
          </div>
