    ...
    <main className="min-h-screen bg-[#2E3944]">
                ...
                <div className="rounded-lg bg-[#212a31] p-4">
                  <div className="flex flex-col items-center gap-3 text-center md:flex-row md:justify-center">
                    ...
                    <div className="text-center md:text-left">
                      ...
                      <p className="text-xs text-[#D3D9D4]">Trusted by Jailbreak communities</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-muted mb-12 text-center text-3xl font-bold">Bot Features</h2>
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {/* Feature 1 */}
            <div className="rounded-lg border border-[#2E3944] bg-[#212a31] p-6">
              <div className="mb-4 flex items-center gap-2">
                <CalendarIcon className="h-6 w-6 text-[#5865F2]" />
                <h3 className="text-muted text-xl font-semibold">Season Tracking</h3>
              </div>
            ...
            <div className="rounded-lg border border-[#2E3944] bg-[#212a31] p-6">
              <div className="mb-4 flex items-center gap-2">
                ...
                <h3 className="text-muted text-xl font-semibold">Changelog Tracking</h3>
              </div>
              <p className="text-[#FFFFFF]">
            ...
            <div className="rounded-lg border border-[#2E3944] bg-[#212a31] p-6">
              <div className="mb-4 flex items-center gap-2">
                ...
                <h3 className="text-muted text-xl font-semibold">Item Tracking</h3>
              </div>
              <p className="text-[#FFFFFF]">
            ...
            <div className="rounded-lg border border-[#2E3944] bg-[#212a31] p-6">
              <div className="mb-4 flex items-center gap-2">
                ...
                <h3 className="text-muted text-xl font-semibold">Fast & Efficient</h3>
              </div>
              <p className="text-[#FFFFFF]">
            ...
            <div className="rounded-lg border border-[#2E3944] bg-[#212a31] p-6">
              <div className="mb-4 flex items-center gap-2">
                ...
                <h3 className="text-muted text-xl font-semibold">Easy Commands</h3>
              </div>
              <p className="text-[#FFFFFF]">
            ...
            <div className="rounded-lg border border-[#2E3944] bg-[#212a31] p-6">
              <div className="mb-4 flex items-center gap-2">
                ...
                <h3 className="text-muted text-xl font-semibold">Trade Notifications</h3>
              </div>
              <p className="text-[#FFFFFF]">
