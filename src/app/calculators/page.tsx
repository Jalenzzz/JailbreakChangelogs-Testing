...
export default function CalculatorsPage() {
  return (
    <div className="container mx-auto px-4 pb-8">
      ...
      <div className="mb-8">
        <h1 className="text-primary-text mb-4 text-4xl font-bold">Jailbreak Calculators</h1>
        <p className="text-secondary-text text-lg">
          Access our calculators in one place. From trading values to season progression, find the
          tools you need.
        </p>
      </div>
