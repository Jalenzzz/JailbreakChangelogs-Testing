          ...
          <div className="mx-auto max-w-6xl">
            ...
            <div className="mb-6">
              <div className="mb-4 flex items-center gap-3">
                <h1 className="text-primary-text text-4xl font-bold">Crew Not Found</h1>
              </div>
            </div>
            ...
            <div className="border-border-primary hover:border-border-focus bg-secondary-bg rounded-lg border p-8 text-center">
              ...
              <p className="text-secondary-text mb-6">
                Season {validSeason} only has {leaderboard.length} crews available. Rank #
                {rankNumber} is out of bounds.
              </p>
    ...
    <div className="min-h-screen text-white">
      <div className="container mx-auto px-4 pb-8">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mb-6">
            <div className="mb-4">
              <h1 className="text-primary-text text-4xl font-bold">Crew Details</h1>
            </div>
          </div>

          <div className="border-border-primary bg-button-info/10 mb-6 flex items-start gap-4 rounded-lg border p-4 shadow-sm">
            <div className="relative z-10">
              <span className="text-primary-text text-base font-bold">Notice</span>
              <div className="text-secondary-text mt-1">
                Badimo&apos;s crew data has not been updated since{' '}
                <span className="font-bold">Sep 29, 2025</span>. This is an upstream issue; we
                cannot refresh the data until it is resolved. Please reach out to{' '}
                <a
