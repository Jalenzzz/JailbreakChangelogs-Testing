  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-6 grid grid-cols-1 gap-4 md:grid-cols-2">
        <div className="animate-pulse rounded-lg border bg-[#212A31] p-4 shadow-sm">
      ...
      <div className="mb-8 animate-pulse rounded-lg border bg-[#212A31] p-6 shadow-sm">
        ...
        <div className="rounded-lg border bg-[#212A31] p-4 shadow-sm">
          <div className="space-y-3">
            {[...Array(10)].map((_, index) => (
              <div
                key={index}
                className="flex animate-pulse flex-col gap-3 rounded-lg border border-[#37424D] p-3 sm:flex-row sm:items-center"
              >
