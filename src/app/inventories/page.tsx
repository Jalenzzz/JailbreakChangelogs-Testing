...
async function OfficialBotsSection() {
  ...
  const botAvatarData = botIds.length > 0 ? await fetchRobloxAvatars(botIds) : {};

  return (
    <div className="mt-8">
      <h2 className="text-primary-text mb-4 text-xl font-bold">Official Scan Bots</h2>
      <div className="border-border-primary bg-secondary-bg shadow-card-shadow rounded-lg border p-4">
        <div className="mb-3">
                ...
                <div className="min-w-0 flex-1">
                  <div className="flex items-start gap-2">
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="text-secondary-text text-sm break-words">@{username}</div>
                    </div>
...
async function LeaderboardSection() {
  try {
    ...
    if (!leaderboard || leaderboard.length === 0) {
      return (
        <div className="mt-8">
          <h2 className="text-primary-text mb-4 text-xl font-bold">Most Scanned Players</h2>
          <div className="border-border-primary bg-secondary-bg shadow-card-shadow rounded-lg border p-6">
            <div className="text-center">
              ...
              <p className="text-secondary-text">
                Unable to load the leaderboard data. Please try refreshing the page.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="mt-8">
        ...
        <div className="border-border-primary bg-secondary-bg shadow-card-shadow rounded-lg border p-6">
          <div className="text-center">
            ...
            <h3 className="text-status-error mb-2 text-lg font-semibold">Leaderboard Error</h3>
            <p className="text-secondary-text">
...
function LeaderboardUser({
  ...
  return (
    <div
      ...
      style={{
        ...(index === 0 && {
          background: 'linear-gradient(to right, hsl(45, 100%, 50%, 0.2), hsl(45, 100%, 45%, 0.2))',
        ...
        ...(index === 2 && {
          background: 'linear-gradient(to right, hsl(30, 100%, 50%, 0.2), hsl(30, 100%, 45%, 0.2))',
