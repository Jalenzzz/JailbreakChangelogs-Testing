                    ...
                    <div className="container mx-auto px-4">
                      <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                        ...
                        <div className="space-y-4">
                          <h3 className="text-muted mb-4 text-lg font-semibold">Follow Us</h3>
                        ...
                        {/* Resources */}
                        <div className="space-y-4">
                          <h3 className="text-muted mb-4 text-lg font-semibold">Resources</h3>
                        ...
                        {/* About */}
                        <div className="space-y-4">
                          <h3 className="text-muted mb-4 text-lg font-semibold">About</h3>
                          <div className="space-y-2">
                            ...
                            <p className="text-muted">
                              Operated by Jailbreak Changelogs LLC, maintained by{' '}
                              <a
                      ...
                      <div className="mt-12 border-t border-[#2E3944] pt-8">
                        <div className="flex flex-col items-start justify-between gap-4 lg:flex-row lg:items-center">
                          <p className="text-muted">
                            &copy; {new Date().getFullYear()} Jailbreak Changelogs. All rights
                            reserved.
                          </p>
                ...
                <div className="container mx-auto px-4">
                  <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div className="space-y-4">
                      <h3 className="text-muted mb-4 text-lg font-semibold">About</h3>
                      <div className="space-y-2">
                        <p className="text-muted">This project is NOT affiliated with Badimo.</p>
                  ...
                  <div className="mt-12 border-t border-[#2E3944] pt-8">
                    <div className="flex flex-col gap-6">
                      <p className="text-muted text-sm leading-relaxed">
                        &copy; {new Date().getFullYear()} Jailbreak Changelogs LLC. Jailbreak
                        Changelogs, JBCL, and any associated logos are trademarks, service marks,
                        and/or registered trademarks of Jailbreak Changelogs LLC.
                      </p>
