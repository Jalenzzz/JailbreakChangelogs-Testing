    ...
    <main className="min-h-screen bg-[#2E3944]">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-muted mb-12 text-center text-3xl font-bold">Features</h2>
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="rounded-lg border border-[#2E3944] bg-[#212a31] p-6">
              <div className="mb-4 flex items-center gap-2">
                ...
                <h3 className="text-muted text-xl font-semibold">Changelogs & Seasons</h3>
              </div>
            ...
            <div className="rounded-lg border border-[#2E3944] bg-[#212a31] p-6">
              <div className="mb-4 flex items-center gap-2">
                ...
                <h3 className="text-muted text-xl font-semibold">Private Servers</h3>
              </div>
              <p className="text-[#FFFFFF]">
            ...
            <div className="rounded-lg border border-[#2E3944] bg-[#212a31] p-6">
              <div className="mb-4 flex items-center gap-2">
                ...
                <h3 className="text-muted text-xl font-semibold">Community Engagement</h3>
              </div>
              <p className="text-[#FFFFFF]">
            ...
            <div className="rounded-lg border border-[#2E3944] bg-[#212a31] p-6">
              <div className="mb-4 flex items-center gap-2">
                ...
                <h3 className="text-muted text-xl font-semibold">Values Database</h3>
              </div>
              <p className="text-[#FFFFFF]">
            ...
            <div className="rounded-lg border border-[#2E3944] bg-[#212a31] p-6">
              <div className="mb-4 flex items-center gap-2">
                ...
                <h3 className="text-muted text-xl font-semibold">Trading Hub</h3>
              </div>
              <p className="text-[#FFFFFF]">
            ...
            <div className="rounded-lg border border-[#2E3944] bg-[#212a31] p-6">
              <div className="mb-4 flex items-center gap-2">
                ...
                <h3 className="text-muted text-xl font-semibold">Dupe Detection System</h3>
              </div>
              <p className="text-[#FFFFFF]">
