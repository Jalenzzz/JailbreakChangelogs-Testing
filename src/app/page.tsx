        ...
        <div className="relative z-10 container mx-auto px-4">
          <div className="text-center">
            ...
            <p
              ...
              style={{ color: 'var(--color-form-button-text)' }}
            >
              Your comprehensive platform for Roblox Jailbreak item values, trade listings, update
              tracking, and community features. Get accurate trading data, post trade ads, track
              seasonal changes, and connect with other players!
            </p>
            <a
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="bg-secondary-bg border-border-primary hover:border-border-focus hover:shadow-card-shadow rounded-lg border p-6 transition-colors duration-200 hover:shadow-lg">
              ...
              <p className="text-card-paragraph">
                Access the complete history of Jailbreak updates since 2017, seasonal rewards,
                contracts, and XP calculators to track your progress.
              </p>
            </div>
            ...
            <div className="bg-secondary-bg border-border-primary hover:border-border-focus hover:shadow-card-shadow rounded-lg border p-6 transition-colors duration-200 hover:shadow-lg">
              ...
              <p className="text-card-paragraph">
                Check inventories, find OG owners, detect duped items, and view money leaderboards
                to track player progress and item ownership.
              </p>
            </div>
            ...
            <div className="bg-secondary-bg border-border-primary hover:border-border-focus hover:shadow-card-shadow rounded-lg border p-6 transition-colors duration-200 hover:shadow-lg">
              ...
              <p className="text-card-paragraph">
                View item values, create trade ads, calculate trading worth, and access official
                trading statistics from Badimo.
              </p>
            </div>
            ...
            <div className="bg-secondary-bg border-border-primary hover:border-border-focus hover:shadow-card-shadow rounded-lg border p-6 transition-colors duration-200 hover:shadow-lg">
              ...
              <p className="text-card-paragraph">
                Join discussions, create profiles, track crew leaderboards, and browse private
                servers with OAuth-secured community engagement.
              </p>
            </div>
            ...
            <div className="bg-secondary-bg border-border-primary hover:border-border-focus hover:shadow-card-shadow rounded-lg border p-6 transition-colors duration-200 hover:shadow-lg">
              ...
              <p className="text-card-paragraph">
                Browse and submit private servers for grinding, hanging out, trading, and more.
            ...
            <div className="bg-secondary-bg border-border-primary hover:border-border-focus hover:shadow-card-shadow rounded-lg border p-6 transition-colors duration-200 hover:shadow-lg">
              ...
              <p className="text-card-paragraph">
                Access XP calculators, dupe detection, crew rankings, and money leaderboards for
                comprehensive Jailbreak analytics and tracking.
              </p>
            </div>
          </div>
