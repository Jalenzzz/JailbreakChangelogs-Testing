    ...
    <div className="text-primary-text relative min-h-screen p-8">
      ...
      <div className="relative mx-auto max-w-4xl">
        ...
        <div className="mb-2 flex items-center gap-2">
          ...
          <h1 className="text-primary-text text-2xl font-bold">Privacy Policy</h1>
        </div>
        <p className="text-primary-text mb-6 text-sm">Last updated: October 9th, 2025</p>
          ...
          <div className="mt-6 space-y-6">
            <div>
              ...
              <Typography className="text-secondary-text mb-4">
                If you choose to authenticate with Discord, we collect the following publicly
            ...
            <div>
              ...
              <Typography className="text-secondary-text mb-4">
                If you choose to authenticate with Roblox, we collect the following publicly
                available information:
              </Typography>
              <ul className="text-secondary-text list-inside list-disc space-y-1">
            ...
            <div>
              <h2 className="text-primary-text mb-4 text-xl font-semibold">Cookies</h2>
              <Typography className="text-secondary-text">
                Our website may use cookies to enhance user experience. However, we do not track or
                collect any information through cookies.
              </Typography>
            </div>
            ...
            <div>
              ...
              <Typography className="text-secondary-text mb-4">
                ...
                information for site optimization, fraud/security purposes, and advertising.
              </Typography>
              <Typography className="text-secondary-text">
            ...
            <div>
              <h2 className="text-primary-text mb-4 text-xl font-semibold">Third-Party Links</h2>
              <Typography className="text-secondary-text">
            ...
            <div>
              ...
              <Typography className="text-secondary-text mb-4">
                You have the right to request deletion of your data at any time. If you would like
                to request deletion of your inventory data or any other information we have
                collected, you can contact us through the following methods:
              </Typography>
              <ul className="text-secondary-text list-inside list-disc space-y-1">
                <li>
                  Join our{' '}
              ...
              <Typography className="text-secondary-text mt-4">
                We will process your deletion request promptly and confirm once your data has been
            ...
            <div>
              <h2 className="text-primary-text mb-4 text-xl font-semibold">Contact Us</h2>
              <Typography className="text-secondary-text">
