      ...
      <div className="relative mx-auto max-w-4xl">
        ...
        <div className="rounded-lg border border-[#2E3944] bg-[#212A31] p-6 transition-colors hover:border-[#5865F2]">
          ...
          <div className="mt-6 space-y-6">
            <div>
              <h2 className="text-muted mb-4 text-xl font-semibold">1. Acceptance of Terms</h2>
              <Typography className="text-muted">
                By accessing and using Jailbreak Changelogs, you accept and agree to be bound by the
                terms and provisions of this agreement. You confirm that you&apos;re at least 13
                years old and meet the minimum age required by the laws in your country. If you are
                old enough to access our services in your country, but not old enough to have
                authority to consent to our terms, your parent or legal guardian must agree to our
                terms on your behalf. Please ask your parent or legal guardian to read these terms
                with you. If you&apos;re a parent or legal guardian and you allow your child (who
                must meet the minimum age for your country) to use the services, then these terms
                also apply to you and you&apos;re responsible for your child&apos;s activity on the
                services, including purchases made by them.
              </Typography>
            </div>

            <div>
              <h2 className="text-muted mb-4 text-xl font-semibold">2. Use License</h2>
              <Typography className="text-muted mb-4">
                Permission is granted to temporarily access and use our materials for personal,
              ...
              <div className="mt-2 ml-4">
                <h3 className="text-muted mb-2 text-lg font-semibold">API Terms of Service</h3>
                <Typography className="text-muted mb-2">
                  By accessing our API, you accept that we reserve the right to restrict or revoke
                  your access and block IP address(es) at our sole discretion.
                </Typography>
                <Typography className="text-muted mb-2">
            ...
            <div>
              <h2 className="text-muted mb-4 text-xl font-semibold">3. Disclaimer</h2>
              <Typography className="text-muted">
            ...
            <div>
              <h2 className="text-muted mb-4 text-xl font-semibold">5. Revisions and Errata</h2>
              <Typography className="text-muted">
                We reserve the right to make changes to our Terms of Service at any time without
            ...
            <div>
              <h2 className="text-muted mb-4 text-xl font-semibold">6. Refund Policy</h2>
              <Typography className="text-muted">
                All supporter purchases are one-time only and non-refundable. By making a supporter
                purchase, you acknowledge and agree that you will not be entitled to a refund for
                any reason. For more information about supporter purchases and their benefits,
                please visit our{' '}
                <Link
                  href="/supporting"
            ...
            <div>
              <h2 className="text-muted mb-4 text-xl font-semibold">7. Contact Information</h2>
              <Typography className="text-muted">
