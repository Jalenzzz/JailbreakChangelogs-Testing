    ...
    <div className="text-primary-text relative min-h-screen p-8">
      ...
      <div className="relative mx-auto max-w-4xl">
        ...
        <div className="mb-2 flex items-center gap-2">
          ...
          <h1 className="text-primary-text text-2xl font-bold">Terms of Service</h1>
        </div>
        ...
        <div className="border-border-primary hover:border-border-focus bg-secondary-bg rounded-lg border p-6 transition-colors">
          ...
          <div className="mt-6 space-y-6">
            ...
            <div>
              <h2 className="text-primary-text mb-4 text-xl font-semibold">2. Use License</h2>
            ...
            <div>
              <h2 className="text-primary-text mb-4 text-xl font-semibold">3. Disclaimer</h2>
              <Typography className="text-secondary-text">
            ...
            <div>
              <h2 className="text-primary-text mb-4 text-xl font-semibold">4. Limitations</h2>
              <Typography className="text-secondary-text">
            ...
            <div>
              <h2 className="text-primary-text mb-4 text-xl font-semibold">6. Refund Policy</h2>
              <Typography className="text-secondary-text">
