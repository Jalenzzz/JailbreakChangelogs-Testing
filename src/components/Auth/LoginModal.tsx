                      ...
                      <p className="text-secondary-text text-center text-sm">
                        {campaign ? (
                          <>
                            ...
                            <span className="text-button-info font-medium">{campaign}</span>{' '}
                            campaign! Your login helps the campaign owner track participation and
                            engagement. We only collect your publicly available Discord details.
                            Your data security is important to us - there&apos;s no need to provide
                            a password.
                          </>
                        ) : (
                          <>
