...
const ChangelogComments = dynamic(() => import('../PageComments/ChangelogComments'), {
  loading: () => <div className="bg-secondary-bg h-64 animate-pulse rounded" />,
  ssr: true,
});
...
const ChangelogContent: React.FC<ChangelogContentProps> = ({
  ...
  const prevChangelog =
    currentIndex < changelogList.length - 1 ? changelogList[currentIndex + 1] : null;
    ...
    <>
      ...
      <div className="grid grid-cols-1 gap-8 xl:grid-cols-12">
        ...
        <div className="sm:col-span-12 xl:col-span-8">
          ...
          {/* AI Summary */}
          <ChangelogSummary changelogId={changelogId} title={title} content={sections} />
