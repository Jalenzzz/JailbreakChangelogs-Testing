      ...
      >
        <div className="flex flex-col items-center gap-4 sm:flex-row sm:gap-6">
          ...
          <div className="flex-1 text-center sm:text-left">
            ...
            {currentSeason !== 19 && (
              <p className="text-sm text-gray-400">Season {currentSeason} • Historical Data</p>
            )}
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="relative overflow-hidden rounded-lg border border-blue-500/30 bg-gradient-to-br from-blue-500/20 to-purple-500/20 p-4">
            ...
            <div className="relative z-10">
              <div className="mb-1 text-2xl font-bold text-white">{formatRating(crew.Rating)}</div>
          ...
          <div className="relative overflow-hidden rounded-lg border border-green-500/30 bg-gradient-to-br from-green-500/20 to-emerald-500/20 p-4">
            ...
            <div className="relative z-10">
              <div className="mb-1 text-2xl font-bold text-white">{crew.BattlesPlayed}</div>
              <div className="text-sm font-medium text-green-300">Battles Played</div>
            </div>
          </div>
          ...
          <div className="relative overflow-hidden rounded-lg border border-yellow-500/30 bg-gradient-to-br from-yellow-500/20 to-orange-500/20 p-4">
            ...
            <div className="relative z-10">
              <div className="mb-1 text-2xl font-bold text-white">{winRate}%</div>
              <div className="text-sm font-medium text-yellow-300">Win Rate</div>
          ...
          <div className="relative overflow-hidden rounded-lg border border-purple-500/30 bg-gradient-to-br from-purple-500/20 to-pink-500/20 p-4">
            ...
            <div className="relative z-10">
              <div className="mb-1 text-2xl font-bold text-white">{crew.MemberUserIds.length}</div>
          ...
          <div className="relative overflow-hidden rounded-lg border border-indigo-500/30 bg-gradient-to-br from-indigo-500/20 to-blue-500/20 p-4">
            ...
            <div className="relative z-10">
              <div className="mb-1 text-lg font-bold text-white">{lastBattleDate}</div>
              <div className="text-sm font-medium text-indigo-300">Last Battle</div>
              <div className="mt-1 text-xs text-indigo-200">{timeSinceLastBattle}</div>
            </div>
          </div>
          ...
          <div className="relative overflow-hidden rounded-lg border border-red-500/30 bg-gradient-to-br from-red-500/20 to-pink-500/20 p-4">
            ...
            <div className="relative z-10">
              <div className="mb-1 text-lg font-bold text-white">{crew.BattlesWon}</div>
              <div className="text-sm font-medium text-red-300">Battles Won</div>
              <div className="mt-1 text-xs text-red-200">of {crew.BattlesPlayed} total</div>
            </div>
          </div>
        </div>
    ...
    <div className="flex items-center gap-2 rounded-lg border border-[#37424D] p-3 transition-colors hover:bg-[#37424D] sm:gap-3">
      ...
      <div className="min-w-0 flex-1">
        <div className="flex flex-col gap-1 sm:flex-row sm:items-center sm:gap-2">
          ...
          {username && (
            <span className="truncate text-xs text-gray-300 sm:text-sm">(@{username})</span>
          )}
          {isOwner && (
