    ...
    <div className="space-y-8">
      ...
      <div
        ...
        style={{
          ...
          ...(rank === 2 && {
            background: 'linear-gradient(to right, hsl(0, 0%, 75%, 0.2), hsl(0, 0%, 65%, 0.2))',
            ...
            <div className="mb-4 flex flex-col items-center gap-4 sm:flex-row sm:items-start">
              <div
                ...
                style={{
                  ...
                  ...(rank === 3 && {
                    background: 'linear-gradient(to right, hsl(30, 100%, 50%), hsl(30, 100%, 45%))',
                    WebkitBackgroundClip: 'text',
                    WebkitTextFillColor: 'transparent',
                    backgroundClip: 'text',
                  }),
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="border-border-primary hover:border-border-focus bg-primary-bg relative overflow-hidden rounded-lg border p-4">
            ...
            <div className="relative z-10">
              ...
              <div className="text-secondary-text text-sm font-medium">Rating</div>
            </div>
          </div>
          ...
          <div className="border-border-primary hover:border-border-focus bg-primary-bg relative overflow-hidden rounded-lg border p-4">
            ...
            <div className="relative z-10">
              <div className="text-primary-text mb-1 text-2xl font-bold">{crew.BattlesPlayed}</div>
              <div className="text-secondary-text text-sm font-medium">Battles Played</div>
            </div>
          </div>
          ...
          <div className="border-border-primary hover:border-border-focus bg-primary-bg relative overflow-hidden rounded-lg border p-4">
            ...
            <div className="relative z-10">
              <div className="text-primary-text mb-1 text-2xl font-bold">{winRate}%</div>
              <div className="text-secondary-text text-sm font-medium">Win Rate</div>
          ...
          <div className="border-border-primary hover:border-border-focus bg-primary-bg relative overflow-hidden rounded-lg border p-4">
            ...
            <div className="relative z-10">
              ...
              <div className="text-secondary-text text-sm font-medium">Members</div>
            </div>
          </div>
          ...
          <div className="border-border-primary hover:border-border-focus bg-primary-bg relative overflow-hidden rounded-lg border p-4">
            ...
            <div className="relative z-10">
              <div className="text-primary-text mb-1 text-lg font-bold">{lastBattleDate}</div>
              <div className="text-secondary-text text-sm font-medium">Last Battle</div>
              <div className="text-tertiary-text mt-1 text-xs">{timeSinceLastBattle}</div>
            </div>
          </div>
          ...
          <div className="border-border-primary hover:border-border-focus bg-primary-bg relative overflow-hidden rounded-lg border p-4">
            ...
            <div className="relative z-10">
              <div className="text-primary-text mb-1 text-lg font-bold">{crew.BattlesWon}</div>
              <div className="text-secondary-text text-sm font-medium">Battles Won</div>
              <div className="text-tertiary-text mt-1 text-xs">of {crew.BattlesPlayed} total</div>
            </div>
          </div>
        </div>
    ...
    <div className="border-border-primary hover:border-border-focus flex items-center gap-2 rounded-lg border p-3 transition-colors sm:gap-3">
      ...
      <div className="min-w-0 flex-1">
        <div className="flex flex-col gap-1 sm:flex-row sm:items-center sm:gap-2">
          ...
          {username && (
            <span className="text-secondary-text truncate text-xs sm:text-sm">(@{username})</span>
          )}
          {isOwner && (
