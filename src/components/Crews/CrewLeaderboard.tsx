...
function CrewLeaderboardEntry({
  ...
  return (
    <div
      className={`flex flex-col sm:flex-row sm:items-center gap-3 p-6 rounded-lg border transition-colors ${
        index === 0
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-2 mb-1">
          <h3
            className={`text-lg sm:text-xl md:text-2xl lg:text-3xl text-white break-words ${bangers.className}`}
          >
            <a
