...
export default function DupeFinderResults({
  ...
  if (!initialData || initialData.length === 0) {
    return (
      <div className="rounded-lg border border-[#2E3944] bg-[#212A31] p-6 shadow-sm">
        <div className="text-center">
          <div className="mb-2 text-lg font-medium text-gray-400">No Dupe Items Found</div>
          <div className="text-gray-500">No duped items found for this user.</div>
        </div>
      </div>
    );
  }
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-lg border border-[#2E3944] bg-[#212A31] p-6 shadow-sm">
        ...
        <div className="mb-4 flex items-center justify-between">
          <h3 className="text-lg font-semibold text-gray-300">{filteredData.length} items found</h3>
        </div>
