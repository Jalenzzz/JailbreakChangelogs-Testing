...
const DupeReportHeader: React.FC = () => {
  return (
    <div className="border-stroke bg-secondary-bg mb-8 rounded-lg border p-6">
      ...
      <div className="border-stroke bg-button-info/10 mb-2 flex items-start gap-4 rounded-lg border p-4 shadow-sm">
        <div className="relative z-10">
          <span className="text-primary-text text-base font-bold">Important Notice</span>
          <div className="text-secondary-text mt-1">
            ...
            .
            <br />
            For the most accurate and up-to-date dupe detection, please use our new{' '}
            <Link
              href="/dupes"
