...
export default function DupeStats({
  ...
  return (
    <div className="border-border-primary bg-secondary-bg shadow-card-shadow rounded-lg border p-6">
      <h2 className="text-primary-text mb-4 text-xl font-semibold">Duplicate Statistics</h2>
      ...
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
        ...
        <div className="border-border-primary bg-tertiary-bg rounded-lg border p-4">
          ...
          <p className="text-primary-text text-2xl font-bold">{duplicateStats.totalItems}</p>
        </div>

        {/* Unique Items */}
        <div className="border-border-primary bg-tertiary-bg rounded-lg border p-4">
          <p className="text-secondary-text text-sm">Unique Items</p>
          <p className="text-primary-text text-2xl font-bold">{duplicateStats.uniqueItems}</p>
        </div>

        {/* Duplicate Items */}
        <div className="border-border-primary bg-tertiary-bg rounded-lg border p-4">
          <p className="text-secondary-text text-sm">Duplicate Items</p>
          <p className="text-primary-text text-2xl font-bold">{duplicateStats.duplicateCount}</p>
        </div>

        {/* Total Duplicates */}
        <div className="border-border-primary bg-tertiary-bg rounded-lg border p-4">
          <p className="text-secondary-text text-sm">Total Duplicates</p>
          <p className="text-primary-text text-2xl font-bold">{duplicateStats.totalDuplicates}</p>
        </div>
      </div>
