    ...
    <div className="rounded-lg border border-[#2E3944] bg-[#212A31] p-6 shadow-sm">
      ...
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
        ...
        <div className="rounded-lg bg-[#37424D] p-4">
          ...
          <p className="text-2xl font-bold text-white">{duplicateStats.totalItems}</p>
        </div>

        {/* Unique Items */}
        <div className="rounded-lg bg-[#37424D] p-4">
          <p className="text-muted text-sm">Unique Items</p>
          <p className="text-2xl font-bold text-white">{duplicateStats.uniqueItems}</p>
        </div>

        {/* Duplicate Items */}
        <div className="rounded-lg bg-[#37424D] p-4">
          <p className="text-muted text-sm">Duplicate Items</p>
          <p className="text-2xl font-bold text-white">{duplicateStats.duplicateCount}</p>
        </div>

        {/* Total Duplicates */}
        <div className="rounded-lg bg-[#37424D] p-4">
          <p className="text-muted text-sm">Total Duplicates</p>
          <p className="text-2xl font-bold text-white">{duplicateStats.totalDuplicates}</p>
        </div>
      </div>
