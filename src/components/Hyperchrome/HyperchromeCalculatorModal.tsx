    ...
    <Dialog open={open} onClose={onClose} className="relative z-50">
      ...
      <div className="fixed inset-0 flex items-center justify-center p-4">
        <Dialog.Panel className="modal-container bg-secondary-bg border-button-info w-full max-w-[480px] min-w-[320px] rounded-lg border shadow-lg">
          <div className="modal-header text-primary-text border-secondary-text flex items-center justify-between border-b px-6 py-4 text-xl font-semibold">
              ...
              <div className="mb-4">
                <div className="border-stroke bg-secondary-bg rounded-lg border p-4">
                  ...
                  <div className="text-secondary-text mt-2 text-xs">
                    ...
                    <span className="text-primary-text px-1 font-semibold">66.6%</span>
                    in private servers. Robbing in a public server at that point guarantees an
                    instant level-up
                  </div>
                  <div className="text-secondary-text mt-2 text-xs">
              ...
              <div className="mb-4">
                <div className="border-stroke bg-secondary-bg rounded-lg border p-4">
                  ...
                  {parseFloat(otherPity[1]) <= 100 && (
                    <div className="text-secondary-text text-base">
                      Level 1 <FaArrowRight className="mx-1 inline" /> Level 2: {otherPity[1]}%
                    </div>
                  )}
                  {parseFloat(otherPity[2]) <= 100 && (
                    <div className="text-secondary-text text-base">
                      Level 2 <FaArrowRight className="mx-1 inline" /> Level 3: {otherPity[2]}%
                    </div>
                  )}
                  {parseFloat(otherPity[3]) <= 100 && (
                    <div className="text-secondary-text text-base">
                      Level 3 <FaArrowRight className="mx-1 inline" /> Level 4: {otherPity[3]}%
                    </div>
                  )}
                  {parseFloat(otherPity[4]) <= 100 && (
                    <div className="text-secondary-text text-base">
                      Level 4 <FaArrowRight className="mx-1 inline" /> Level 5: {otherPity[4]}%
                    </div>
                  )}
                </div>
              </div>
