    ...
    <div className="bg-[#212A31] rounded-lg border border-[#2E3944] p-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-2 sm:gap-4">
        <div className="text-center">
          ...
          >
            <div className="text-2xl font-bold text-white cursor-help">
        ...
        <div className="text-center">
          ...
          >
            <div className="text-2xl font-bold text-[#4ade80] cursor-help">
              {formatNumber(
        ...
        <div className="text-center">
          ...
          >
            <div className="text-2xl font-bold text-[#ff6b6b] cursor-help">
              {formatNumber(
                initialData.data.filter((item) => !item.isOriginalOwner).length,
              )}
            </div>
      ...
      <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="text-center p-4 bg-[#2E3944] rounded-lg border border-[#37424D]">
          ...
          {isLoadingValues ? (
            <div className="text-2xl font-bold text-[#1d7da3] animate-pulse">
              Loading...
            </div>
          ) : (
            <Tooltip
