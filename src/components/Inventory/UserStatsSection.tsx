...
export default function UserStatsSection({
  ...
  const createdRelativeTime = useRealTimeRelativeDate(currentData?.created_at || 0);
  const updatedRelativeTime = useRealTimeRelativeDate(currentData?.updated_at || 0);
  ...
  return (
    <div className="space-y-4">
      ...
      {currentData.gamepasses && currentData.gamepasses.length > 0 && (
        <div className="mt-6">
          <h3 className="text-primary-text mb-2 text-lg font-medium">Gamepasses</h3>
            ...
            {(() => {
              ...
              return orderedGamepasses.map((gamepass) => {
                ...
                const GamepassContent = () => (
                  <div className="text-form-button-text border-button-info bg-button-info hover:bg-button-info-hover flex items-center gap-2 rounded-lg border px-3 py-2 text-sm transition-colors">
      ...
      <div className="text-secondary-text mt-4 space-y-1 text-sm">
        ...
        <p>
          <span className="text-primary-text font-semibold">First Scanned:</span>{' '}
