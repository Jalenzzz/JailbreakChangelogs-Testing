    ...
    <div className="bg-secondary-bg border-border-primary hover:shadow-card-shadow mb-8 space-y-6 rounded-lg border p-6 shadow-lg transition-all duration-200">
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
        ...
        <div className="bg-primary-bg border-border-primary rounded-lg border p-4">
          ...
          <p className="text-primary-text text-3xl font-bold">{formatFullValue(cashValue)}</p>
        </div>
        ...
        <div className="bg-primary-bg border-border-primary rounded-lg border p-4">
          ...
          <p className="text-primary-text text-3xl font-bold">{formatFullValue(dupedValue)}</p>
        </div>
        ...
        <div className="bg-primary-bg border-border-primary rounded-lg border p-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <p className="text-primary-text text-3xl font-bold">{formatPrice(price)}</p>
          </div>
        </div>
        ...
        {type.toLowerCase() === 'vehicle' && (
          <div className="bg-primary-bg border-border-primary rounded-lg border p-4">
            ...
            <p className="text-primary-text text-3xl font-bold">{health || '???'}</p>
          </div>
        )}
