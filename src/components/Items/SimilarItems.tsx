      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-3 gap-4">
          {similarItems.map((item, index) => (
            ...
            >
              <div
                className={`relative overflow-hidden rounded-lg transition-all duration-300 hover:shadow-lg hover:-translate-y-0.5 ${
                  item.is_seasonal === 1
                ...
                <div className="flex flex-1 flex-col space-y-2 p-3">
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="flex items-center justify-between bg-gradient-to-r from-[#2E3944] to-[#1a202c] rounded-lg p-1.5">
                      ...
                      <span
                        className={`text-[9px] px-1.5 py-0.5 font-bold rounded-lg shadow-sm whitespace-nowrap ${getDemandColor(item.demand)}`}
                      >
                    ...
                    {item.trend && item.trend !== "N/A" && (
                      <div className="flex items-center justify-between bg-gradient-to-r from-[#2E3944] to-[#1a202c] rounded-lg p-1.5">
                        ...
                        <span
                          className={`text-[9px] px-1.5 py-0.5 font-bold rounded-lg shadow-sm whitespace-nowrap ${getTrendColor(item.trend)}`}
                        >
                          {item.trend}
                        </span>
                      </div>
