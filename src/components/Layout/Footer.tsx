          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4">
              ...
              >
                ...
                >
                  <Icon icon="prime:twitter" className="text-primary-text h-6 w-6" inline={true} />
                </a>
              </Tooltip>
              <Tooltip
              ...
              >
                <a
                  ...
                  aria-label="Discord"
                >
                  <Icon icon="skill-icons:discord" className="h-6 w-6" inline={true} />
                </a>
              </Tooltip>
              <Tooltip
              ...
              >
                <a
                  ...
                  aria-label="Bluesky"
                >
                  <Icon icon="logos:bluesky" className="h-6 w-6" inline={true} />
                </a>
              </Tooltip>
            </div>
            <div className="pt-4">
              ...
              >
                <Icon icon="logos:reddit-icon" className="h-5 w-5" inline={true} />
                r/RobloxJailbreak
              </a>
              <a
              ...
              >
                <Icon icon="skill-icons:discord" className="h-5 w-5" inline={true} />
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Link
                ...
                className="text-link hover:text-link-hover active:text-link-active flex items-center gap-2 transition-colors duration-200"
              >
                <Icon icon="material-symbols:question-mark" className="h-5 w-5" inline={true} />
                FAQ
              </Link>
              <Link
                href="/redeem"
                className="text-link hover:text-link-hover active:text-link-active flex items-center gap-2 transition-colors duration-200"
              >
                <Icon icon="material-symbols:redeem-rounded" className="h-5 w-5" inline={true} />
                Redeem Code
              </Link>
              <Link
                href="/bot"
