...
export default function Header({ initialUser }: { initialUser?: UserData | null }) {
  ...
  const [communityMenuCloseTimeout, setCommunityMenuCloseTimeout] = useState<NodeJS.Timeout | null>(
    null,
  );
  const [seasonsMenuCloseTimeout, setSeasonsMenuCloseTimeout] = useState<NodeJS.Timeout | null>(
    null,
  );
  useEscapeLogin();
  ...
  return (
    <>
      ...
      <LoginModalWrapper open={showLoginModal} onClose={() => setShowLoginModal(false)} />
      ...
      {isDiscordModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          <div className="absolute inset-0" onClick={() => setIsDiscordModalOpen(false)} />
          <iframe
