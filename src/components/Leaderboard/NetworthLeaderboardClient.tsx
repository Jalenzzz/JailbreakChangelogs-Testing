...
export default function NetworthLeaderboardClient({
  ...
  const [selectedUser, setSelectedUser] = useState<NetworthLeaderboardEntry | null>(null);
      ...
      try {
        ...
        for (const batch of batches) {
          try {
            ...
            console.error(`Failed to fetch batch for networth leaderboard:`, error);
          }
        }
      } catch (error) {
        console.error('Failed to fetch user data for networth leaderboard:', error);
      }
    };
    ...
    <>
      ...
      {selectedUser && (
        <InventoryBreakdownModal
          ...
          username={userDataMap[selectedUser.user_id]?.name || selectedUser.user_id}
