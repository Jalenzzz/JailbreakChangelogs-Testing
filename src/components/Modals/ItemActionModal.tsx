          ...
          <div className="p-4 sm:p-6">
            <div className="space-y-3">
              ...
              <button
                ...
                className="flex w-full cursor-pointer items-center gap-3 rounded-lg border p-3 text-left text-white transition-colors sm:p-4"
              >
                <div>
              ...
              {hasTradeHistory ? (
                ...
                <div className="flex w-full items-center gap-3 rounded-lg border p-3 text-left text-gray-500 sm:p-4">
                  <div>
