...
export default function ItemActionModal({
  ...
  const hasTradeHistory = item.history && Array.isArray(item.history) && item.history.length > 1;
  ...
  return (
    <Dialog open={isOpen} onClose={onClose} className="relative z-50">
      ...
      <div className="fixed inset-0 flex items-center justify-center p-4">
        <div className="mx-auto max-h-[80vh] w-full max-w-sm overflow-hidden rounded-lg border border-[#5865F2] sm:max-w-md">
          {/* Modal Header */}
          <div className="border-b bg-[#212A31] p-4 sm:p-6">
            <div className="flex items-start justify-between gap-4 sm:items-center">
              ...
              <button onClick={onClose} className="text-muted rounded-full p-1 hover:text-white">
          ...
          <div className="p-4 sm:p-6">
            <div className="space-y-3">
              ...
              <button
                ...
                className="flex w-full cursor-pointer items-center gap-3 rounded-lg border bg-[#212A31] p-3 text-left text-white transition-colors sm:p-4"
              >
                <div>
              ...
              {hasTradeHistory ? (
                ...
                >
                  <div>
                    ...
                    <div className="text-sm text-gray-400">View trade history for this item</div>
                  </div>
                </button>
              ) : (
                <div className="flex w-full items-center gap-3 rounded-lg border bg-[#212A31] p-3 text-left text-gray-500 sm:p-4">
                  <div>
