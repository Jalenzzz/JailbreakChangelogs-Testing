...
function ScanEntry({ scan, scanNumber }: { scan: ScanHistoryEntry; scanNumber: number }) {
          ...
          <div className="modal-content flex-1 overflow-y-auto p-6">
            ...
            {scanHistory.length >= 1000 && (
              <div className="border-button-info bg-button-info/10 mb-4 rounded-lg border p-4">
                ...
                <div className="text-secondary-text text-sm">
                  ...
                  <span className="text-primary-text font-semibold">1,000</span> scans for this
                  user.
                </div>
              </div>
            )}
            ...
            {scanHistory.length === 0 ? (
              <div className="py-8 text-center">
                <p className="text-secondary-text">No scan history found for this user.</p>
              </div>
            ) : (
