    ...
    <Dialog open={isOpen} onClose={onClose} className="relative z-50">
      ...
      <div className="fixed inset-0 flex items-center justify-center p-4">
        <Dialog.Panel className="mx-auto max-w-2xl w-full bg-[#212A31] rounded-lg shadow-xl border border-[#2E3944] overflow-hidden">
          ...
          <div className="p-6">
            <div className="mb-6">
              <p className="text-[#D3D9D4] mb-4">{featureInfo.description}</p>

              {featureInfo.current && (
                <div className="bg-[#2E3944] rounded-lg p-4 border border-[#37424D]">
                  <span className="text-[#748D92] text-sm">
                    {featureInfo.current}
                  </span>
                </div>
              )}
            ...
            <div className="mb-6">
              ...
              <div className="grid grid-cols-1 gap-4">
                {(() => {
                  ...
                  if (!recommendedTier)
                    return (
                      <div className="text-[#748D92] text-center">
                    ...
                    <div
                      ...
                      className={`relative rounded-lg border-2 ${recommendedTier.color} bg-[#2E3944] p-4 ${
                        recommendedTier.recommended
                          ? "ring-2 ring-[#5865F2] ring-opacity-50"
                          : ""
                      }`}
                    >
                      {recommendedTier.recommended && (
                      ...
                      <div className="flex items-center gap-2 mb-3">
                        ...
                        {recommendedTier.badgeColor && (
                          <div
                            className={`inline-flex items-center justify-center w-5 h-5 rounded-full bg-gradient-to-r ${recommendedTier.badgeColor}`}
                          >
