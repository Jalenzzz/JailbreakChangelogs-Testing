...
function OGUserDataLoadingFallback({ robloxId, ogData }: OGUserDataStreamerProps) {
...
async function OGUserDataFetcher({ robloxId, ogData }: OGUserDataStreamerProps) {
...
export default function OGUserDataStreamer({ robloxId, ogData }: OGUserDataStreamerProps) {
  return (
    <Suspense fallback={<OGUserDataLoadingFallback robloxId={robloxId} ogData={ogData} />}>
