...
export default function Comment({
  ...
  const renderThumbnail = () => {
    ...
    if (isLoading) {
      return (
        <div className="relative w-16 h-16 md:w-32 md:h-[4.5rem] mr-3 rounded-md overflow-hidden flex-shrink-0 bg-[#2E3944] animate-pulse"></div>
      );
    }
        ...
        <div className="flex justify-start items-center text-xs">
          <div className="flex items-center gap-1">
            ...
            >
              <Typography
                variant="caption"
                className="text-[#FFFFFF] cursor-help"
              >
