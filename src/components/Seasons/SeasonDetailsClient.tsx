      ...
      <div className="container mx-auto mb-8 px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 gap-8 xl:grid-cols-12">
          ...
          <div className="sm:col-span-12 xl:col-span-8">
            <h1
              className={`${inter.className} mb-4 text-3xl font-bold text-muted border-b border-[#D3D9D4] pb-2 tracking-tighter`}
            >
              Season {season.season} / {season.title}
            </h1>
            <p className="mb-4 text-muted">{season.description}</p>
            ...
            <h2
              className={`mb-4 text-2xl font-bold text-muted border-b border-[#D3D9D4] pb-2 tracking-tight ${inter.className}`}
            >
              Season Rewards
            </h2>
          ...
          <div className="sm:col-span-12 xl:col-span-4 space-y-8">
            ...
            {premiumStatusLoaded && currentUserPremiumType === 0 && (
              <div className="my-8 flex flex-col items-center">
                <div
                  className="w-full max-w-[700px] bg-[#1a2127] rounded-lg overflow-hidden border border-[#2E3944] shadow transition-all duration-300 relative"
