...
export default function SeasonInfo({
  ...
  return (
    <div className="border-stroke bg-secondary-bg mb-8 rounded-lg border p-6">
      <h2 className="text-muted mb-4 text-2xl font-semibold">Season Information</h2>
      <div className="grid grid-cols-2 gap-6 md:grid-cols-5">
        <div className="text-center">
          <div className="text-muted mb-1 text-sm">Season</div>
          <div className="text-primary-text text-lg font-semibold">{season}</div>
        </div>
        <div className="text-center">
        ...
        <div className="text-center">
          ...
          <div className="text-primary-text text-lg font-semibold">{targetLevel}</div>
        </div>
        <div className="text-center">
          <div className="text-muted mb-1 text-sm">Total Days</div>
          <div className="text-primary-text text-lg font-semibold">{totalDays}</div>
        </div>
        <div className="text-center">
