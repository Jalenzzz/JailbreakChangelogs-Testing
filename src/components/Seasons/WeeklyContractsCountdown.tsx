...
const WeeklyContractsCountdown: React.FC<WeeklyContractsCountdownProps> = ({ season }) => {
    ...
    <div className="border-border-primary hover:border-border-focus bg-secondary-bg relative overflow-hidden rounded-2xl border p-6">
      ...
      <div className="relative z-10">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          ...
          <div className="border-border-primary hover:border-border-focus rounded-xl border p-4">
