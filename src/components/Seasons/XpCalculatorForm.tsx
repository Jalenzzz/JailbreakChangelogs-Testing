...
export default function XpCalculatorForm({
  ...
  return (
    <div className="border-border-primary hover:border-border-focus bg-secondary-bg mb-8 rounded-lg border p-6">
      <h2 className="text-primary-text mb-6 text-2xl font-semibold">🎯 XP Progress Calculator</h2>
      ...
      <div className="mb-6 grid grid-cols-1 gap-6 md:grid-cols-2">
        <div>
          <label className="text-primary-text mb-2 block text-sm font-medium">Current Level</label>
          {selectLoaded ? (
            <Select
          ...
          <div className="text-secondary-text mt-1 text-xs">
            Select your current level (<span className="font-bold">1-{targetLevel - 1}</span>)
          </div>
        </div>
        ...
        <div>
          ...
          />
          <div className="text-secondary-text mt-1 text-xs">
            XP progress within <span className="font-bold">Level {currentLevel}</span> (0-
            <span className="font-bold">{maxXpForCurrentLevel.toLocaleString()} XP</span> needed to
            reach <span className="font-bold">Level {currentLevel + 1}</span>)
          </div>
        </div>
      </div>
    </div>
