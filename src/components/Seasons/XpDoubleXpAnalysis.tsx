...
export default function XpDoubleXpAnalysis({ doubleXpResults }: XpDoubleXpAnalysisProps) {
  return (
    <div className="border-border-primary hover:border-border-focus bg-secondary-bg rounded-lg border p-4">
      <h3 className="text-primary-text mb-3 text-xl font-semibold">🔄 Double XP Analysis</h3>
        ...
        <div className="flex items-center">
          ...
          <span className="text-primary-text">
            ...
            {doubleXpResults.noPass.achievable ? (
              ...
              <>
                <span className="text-button-danger">Not achievable</span> even with Double XP
              </>
            )}
          </span>
        </div>
