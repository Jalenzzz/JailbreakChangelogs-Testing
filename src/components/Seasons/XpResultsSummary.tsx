    ...
    <div className="space-y-6">
      ...
      <div className="border-border-primary hover:border-border-focus bg-secondary-bg rounded-lg border p-6">
        ...
        >
          ...
          <div className="text-secondary-text mb-3">{recommendation.details}</div>
        </div>

        {/* Progress Overview */}
        <div className="mb-6 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
          <div className="text-center">
            <div className="text-primary-text text-2xl font-bold">{results.currentLevel}</div>
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          <div className="border-border-primary hover:border-border-focus bg-primary-bg rounded-lg border p-4">
            <div className="mb-3 flex items-center justify-between">
              <h4 className="text-primary-text flex items-center gap-2 font-semibold">
                <Icon icon="mdi:clock" className="text-blue-400" inline={true} />
                Without Season Pass
              </h4>
              <span className="text-lg">{getStatusIcon(results.achievableNoPass)}</span>
            </div>
            <div className="text-center">
              <div className="text-primary-text text-2xl font-bold">{results.timeNoPass.days}</div>
          ...
          <div className="border-border-primary hover:border-border-focus bg-primary-bg rounded-lg border p-4">
            <div className="mb-3 flex items-center justify-between">
              <h4 className="text-primary-text flex items-center gap-2 font-semibold">
                <Icon icon="mdi:clock" className="text-green-400" inline={true} />
                With Season Pass
              </h4>
