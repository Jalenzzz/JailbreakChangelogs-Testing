        ...
        >
          ...
          <button
            ...
            style={{
              ...
              fontSize: '0.875rem',
              minWidth: '100px',
              cursor: !showFinalWarning && timeLeft > 0 ? 'not-allowed' : 'pointer',
              opacity: !showFinalWarning && timeLeft > 0 ? 0.7 : 1,
            }}
            onMouseEnter={(e) => {
              if (!(!showFinalWarning && timeLeft > 0)) {
                e.currentTarget.style.backgroundColor = 'var(--color-button-danger-hover)';
              }
            }}
            onMouseLeave={(e) => {
              if (!(!showFinalWarning && timeLeft > 0)) {
                e.currentTarget.style.backgroundColor = 'var(--color-button-danger)';
              }
            }}
          >
            {!showFinalWarning
