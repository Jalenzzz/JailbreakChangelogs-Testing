    ...
    <section className="bg-primary-bg">
      <div className="container mx-auto px-4 pt-2 pb-8 sm:px-6">
          ...
          {supporterTiers.map((tier) => (
            ...
            >
              <div className="mb-2 flex items-center gap-2">
                <p className="text-primary-text text-lg font-medium">{tier.name}</p>
                {tier.recommended && (
              ...
              <h4 className="text-primary-text mt-2 text-3xl font-semibold">
                {tier.name === 'Free' ? (
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-secondary-text text-base font-normal"> Robux</span>
                  </div>
                ) : (
                  <>
                    {tier.price}
                    <span className="text-secondary-text text-base font-normal"> USD</span>
                  </>
                )}
              </h4>
        ...
        <div className="bg-button-info/10 border-border-primary mt-8 rounded-lg border p-6">
          <h3 className="text-primary-text mb-4 text-lg font-semibold">Important Information</h3>
          <div className="text-secondary-text space-y-2">
            <p>
              <strong>One-time purchases:</strong> All supporter purchases are one-time only and
              non-refundable! Once you redeem your code, you keep the perks forever.
            </p>
            <p>
              ...
              (e.g.,{' '}
              <code className="bg-surface-bg rounded px-1">Hello there! (1019539798383398946)</code>
              ).
            </p>
            <p>
              <Link
            ...
            <p>
              <strong>Need help?</strong> Didn&apos;t receive a code? Need assistance with your
              donation? Reach out to us at{' '}
              <a
        ...
        <div className="support-methods-section mt-12 grid gap-8 md:grid-cols-3">
          ...
          <div className="bg-secondary-bg border-border-primary rounded-lg border p-6 text-center">
            <h3 className="text-primary-text mb-4 text-lg font-semibold">Crypto Donations</h3>
            <div className="space-y-4">
              <div className="bg-surface-bg border-border-primary rounded-lg border p-4">
                <div className="text-primary-text mb-2 flex items-center justify-center gap-2">
                  <Icon icon="logos:bitcoin" className="h-4 w-4" inline={true} />
                ...
                <div className="flex items-center gap-2">
                  <code className="text-secondary-text flex-1 text-xs break-all">
                    ...
                    <button
                      ...
                      title={copiedAddress === 'BTC' ? 'Copied!' : 'Copy Bitcoin address'}
                    >
                      <Icon
                        icon={copiedAddress === 'BTC' ? 'heroicons:check' : 'heroicons:clipboard'}
                        className="h-4 w-4"
                      />
                    </button>
                  </code>
              ...
              <div className="bg-surface-bg border-border-primary rounded-lg border p-4">
                <div className="text-primary-text mb-2 flex items-center justify-center gap-2">
                  <Icon icon="logos:ethereum" className="h-4 w-4" inline={true} />
                ...
                <div className="flex items-center gap-2">
                  <code className="text-secondary-text flex-1 text-xs break-all">
                    ...
                    <button
                      ...
                      className="text-button-info hover:text-button-info-hover ml-1 cursor-pointer transition-colors"
                      title={copiedAddress === 'ETH' ? 'Copied!' : 'Copy Ethereum address'}
                    >
                      <Icon
                        icon={copiedAddress === 'ETH' ? 'heroicons:check' : 'heroicons:clipboard'}
                        className="h-4 w-4"
                      />
                    </button>
                  </code>
              ...
              <div className="bg-surface-bg border-border-primary rounded-lg border p-4">
                <div className="text-primary-text mb-2 flex items-center justify-center gap-2">
                  <Icon icon="token-branded:ltc" className="h-4 w-4" inline={true} />
                ...
                <div className="flex items-center gap-2">
                  <code className="text-secondary-text flex-1 text-xs break-all">
                    ...
                    <button
                      ...
                      className="text-button-info hover:text-button-info-hover ml-1 cursor-pointer transition-colors"
                      title={copiedAddress === 'LTC' ? 'Copied!' : 'Copy Litecoin address'}
                    >
                      <Icon
                        icon={copiedAddress === 'LTC' ? 'heroicons:check' : 'heroicons:clipboard'}
                        className="h-4 w-4"
                      />
                    </button>
                  </code>
