              ...
              >
                ...
                >
                  <div className="flex flex-col gap-0.5">
                    <h3
                      className={`${inter.className} text-xl font-bold text-blue-300 group-hover:text-blue-400  transition-colors tracking-tighter`}
                    >
                      {changelog.title.split(" / ")[0]}
                    </h3>
                    <p
                      className={`${inter.className} text-sm font-semibold text-muted tracking-tight`}
                    >
