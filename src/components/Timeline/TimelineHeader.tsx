...
const TimelineHeader: React.FC<TimelineHeaderProps> = ({ onViewMore }) => {
  return (
    <div className="mb-8 rounded-lg border border-[#2E3944] bg-[#212A31] p-6">
      <h2 className="text-muted mb-4 text-2xl font-semibold">Roblox Jailbreak Timeline</h2>
      <p className="text-muted mb-4">
        Explore the complete history of Roblox Jailbreak updates, from the game&apos;s launch to the
        latest changes. Track major updates, feature releases, and gameplay evolution
        chronologically.
      </p>
      ...
      <div className="mb-6 grid grid-cols-1 gap-4 sm:grid-cols-3">
        <div className="rounded-lg border border-[#2E3944] bg-[#37424D] p-4">
          <div className="mb-3 flex items-center space-x-3">
            ...
            <div>
              <h3 className="text-muted font-semibold">Chronological History</h3>
            </div>
          </div>
          <p className="text-muted text-sm">
            Timeline entries are displayed from newest to oldest, starting with the latest update at
            the top.
          </p>
        </div>
