  ...
  return (
    ...
    >
      <DialogTitle className="flex items-center justify-between border-b border-[#2E3944] bg-[#1A2228] p-4">
        ...
        <IconButton onClick={onClose} className="hover:text-muted text-[#FFFFFF]" size="small">
      ...
      <DialogContent sx={{ padding: '24px !important' }}>
        <div className="space-y-6">
          ...
          <div>
            <h3 className="text-muted mb-2 text-lg font-semibold">Timeline Navigation</h3>
            <p className="text-[#A0A8B0]">
              Scroll through the timeline to explore Jailbreak&apos;s complete update history
              chronologically.
            </p>
          </div>
        </div>
