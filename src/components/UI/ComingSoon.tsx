      ...
      <div className="relative z-[2] mx-auto max-w-md px-4 text-center">
        <div className="rounded-2xl border border-white/[0.12] bg-[rgba(30,30,30,0.35)] px-8 py-8 shadow-[0_8px_32px_0_rgba(0,0,0,0.25)] backdrop-blur-xl">
          <div className="mb-8">
            ...
            <p className="text-muted mb-4">This feature is currently under active development.</p>
            <p className="text-muted text-sm">
              Join our Discord to test this feature early with our Discord bot (very experimental,
              info may be inaccurate - please report bugs), or stay tuned for the website release!
            </p>
          </div>
