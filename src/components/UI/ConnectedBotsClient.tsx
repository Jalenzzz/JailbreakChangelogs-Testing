      ...
      <div className="rounded-lg border bg-[#212A31] p-4 shadow-sm">
        ...
        {queueInfo && (
          <div className="mb-4 space-y-2 text-sm">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-white">{queueInfo.current_delay.toFixed(2)}s</span>
            </div>
            <div className="flex items-center gap-2">
        ...
        <div className="max-h-60 space-y-2 overflow-y-auto">
          {activeBots.map((bot: ConnectedBot) => (
            <BotStatusCard key={bot.id} bot={bot} usersData={usersData} avatarsData={avatarsData} />
          ))}
        </div>
      </div>
    </div>
...
function BotStatusCard({
  ...
  return (
    <div className="flex items-center justify-between rounded-lg border bg-[#212A31] p-3">
