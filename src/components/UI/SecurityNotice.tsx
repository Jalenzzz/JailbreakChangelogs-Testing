...
export default function SecurityNotice({ className = '' }: SecurityNoticeProps) {
  return (
    <div
    ...
    >
      <div className="relative z-10">
        ...
        <div className="text-secondary-text mt-1">
          If someone claims to be scanning inventories for JBCL but isn&apos;t one of these official
          bots, they are impersonating us. Please report such users to prevent scams.
        </div>
      </div>
    </div>
  );
