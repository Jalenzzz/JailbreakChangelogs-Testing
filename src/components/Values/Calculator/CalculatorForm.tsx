  ...
  return (
    ...
    >
      <div className="text-center">
        <div className="mb-4">
          <svg
            className="mx-auto h-16 w-16 text-muted/50"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
              ...
              >
                ...
                >
                  <div className="relative aspect-square">
                    <div
                      className="relative w-full h-full rounded-lg overflow-hidden bg-[#2E3944] cursor-pointer"
    ...
    <div className="bg-[#2E3944] rounded-lg p-6 overflow-x-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div>
          ...
          <div
            className="bg-[#37424D] rounded-lg p-4"
                  ...
                  >
                    <div>
                      ...
                      <div className="mt-1 flex items-center gap-2">
                        ...
                        <span
                          className={`inline-block px-2 py-0.5 text-xs rounded-full text-white font-semibold ${getDemandColor(demand)}`}
                        >
            ...
            {(() => {
              ...
              return (
                <div className="flex flex-col sm:flex-row flex-wrap items-start sm:items-center gap-2 sm:gap-3 text-xs sm:text-sm text-muted/70 mt-4">
                  <span>
                    Total:{" "}
                    <span className="font-bold text-muted">{t.cashValue}</span>
                  </span>
            ...
            <>
              {(offeringItems.length === 0 || requestingItems.length === 0) &&
                !(
                  ...
                  <div
                    className="mb-4 bg-[#2E3944] rounded-lg p-3 border"
                    style={{
                      borderColor:
