                ...
                <div className="bg-[#2e3944] border border-gray-700/50 rounded-lg overflow-hidden transition-all duration-200 hover:border-purple-500/30 hover:shadow-lg">
                  ...
                  <div className="p-4 space-y-2">
                    <div className="flex items-center justify-between">
                      <h4 className="text-gray-200 font-medium group-hover:text-blue-400 transition-colors line-clamp-1 mr-2">
                        {displayName}
                      </h4>
                      <span
                    ...
                    <div className="flex items-start justify-between text-xs text-muted/80">
                      <span className="flex flex-col space-y-1">
                        <span className="flex items-center gap-1">
                          <span>Cash:</span>
                          <span
                            className="text-xs px-2 py-0.5 rounded-full whitespace-nowrap text-white font-semibold"
                        ...
                        <span className="flex items-center gap-1">
                          <span>Demand:</span>
                          <span
                            className={`text-xs px-2 py-0.5 rounded-full whitespace-nowrap text-white font-semibold ${getDemandColor(itemDemand)}`}
                          >
                        ...
                        <span className="flex items-center gap-1">
                          <span>Trend:</span>
                          <span
                            className={`text-xs px-2 py-0.5 rounded-full whitespace-nowrap text-white font-semibold ${getTrendColor(item.trend || "Unknown")}`}
                          >
                      ...
                      <span className="flex flex-col items-end">
                        {diff === 0 ? (
                          ...
                          >
                            {isAbove ? (
                              ...
                              <FaArrowAltCircleDown className="w-4 h-4" />
                            )}
                            <span>
                        ...
                        {demandDelta === null ? null : demandDelta === 0 ? (
                          ...
                          <span
                            className={`inline-flex items-center gap-1 mt-1 ${demandDelta > 0 ? "text-[#43B581]" : "text-red-400"}`}
                          >
                            {demandDelta > 0 ? (
                              <FaArrowCircleUp className="w-4 h-4" />
                            ) : (
