  ...
  return (
    ...
    >
      <DialogTitle className="flex items-center justify-between border-b p-4">
        <span className="text-status-error font-semibold">Trade Ad Validation Errors</span>
        <Button
          onClick={onClose}
      ...
      <DialogActions className="border-border-primary border-t p-2">
        <Button onClick={onClose} className="text-primary-text hover:bg-quaternary-bg">
          Close
        </Button>
      </DialogActions>
    </Dialog>
