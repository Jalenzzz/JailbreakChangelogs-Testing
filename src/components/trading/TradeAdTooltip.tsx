        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="space-y-1 text-sm">
            ...
            <div className="text-muted flex items-center gap-2">
              <span>Demand:</span>
              <span
                className={`text-xs px-2 py-0.5 rounded-full whitespace-nowrap text-white font-semibold ${getDemandColor(demand)}`}
              >
            ...
            <div className="text-muted flex items-center gap-2">
              <span>Trend:</span>
              <span
                className={`text-xs px-2 py-0.5 rounded-full whitespace-nowrap text-white font-semibold ${getTrendColor(trend || "Unknown")}`}
              >
