                  ...
                  <div className="text-right">
                    <div className="text-muted">
                      ...
                      {item.cash_value === null || item.cash_value === 'N/A'
                        ? 'N/A'
                        : formatCurrencyValue(parseCurrencyValue(item.cash_value))}
                    </div>
                    <div className="text-muted">
                      Duped:{' '}
                      {item.duped_value === null || item.duped_value === 'N/A'
                        ? 'N/A'
                        : formatCurrencyValue(parseCurrencyValue(item.duped_value))}
                    </div>
                  </div>
                </div>
              ))}
              <div className="mt-2 flex items-center justify-between border-t border-[#4A5568] pt-2 font-medium">
                ...
                <div className="text-right">
                  <div className="text-[#FFFFFF]">
                    ...
                    {formatCurrencyValue(
                      groupItems(offering).reduce(
                        (sum, item) => sum + parseCurrencyValue(item.cash_value) * item.count,
                        0,
                      ),
                    )}
                  </div>
                  <div className="text-[#FFFFFF]">
                    ...
                    {formatCurrencyValue(
                      groupItems(offering).reduce(
                        (sum, item) => sum + parseCurrencyValue(item.duped_value) * item.count,
                        0,
                      ),
                    )}
                  </div>
