...
export const Badge = ({
  ...
  const baseClasses = 'rounded border px-1.5 py-0.5 text-[10px] font-semibold uppercase';
      ...
      <div className="flex items-center justify-between px-4 py-3">
        ...
        >
          ...
          <MenuItem setActive={setActive} active={active} item="Values">
            ...
            <HoveredLink href="/values/changelogs">Value Changelogs</HoveredLink>
            <HoveredLink href="/values/calculator">Value Calculator</HoveredLink>
                  ...
                  >
                    ...
                    <div className="border-border-secondary border-b px-4 py-3">
                      <div className="flex items-center gap-3">
                        ...
                        />
                        <div>
                          <div className="text-primary-text font-semibold">{userData.username}</div>
                          <div className="text-secondary-text text-sm">@{userData.username}</div>
                        </div>
                      </div>
                    </div>
