    ...
    >
      ...
      <div className="relative z-[2] container mx-auto max-w-2xl px-4">
        ...
        >
          ...
          >
            <h3 className="mb-4 text-xl font-bold" style={{ color: 'var(--color-primary-text)' }}>
              Stay Connected
            </h3>
          ...
          <a
            ...
            onMouseEnter={(e) => {
              e.currentTarget.style.backgroundColor = 'var(--color-button-info-hover)';
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.backgroundColor = 'var(--color-button-info)';
            }}
          >
