 ...
 */
export const createPresenceAriaLabel = (isOnline: boolean, lastSeen?: string): string => {
  if (isOnline) {
 ...
 */
export const getProgressAriaProps = (label: string, current: number, max: number = 100) => ({
 ...
 */
export const getValueAriaProps = (type: string, value: string | number, unit?: string) => ({
